...
function Footer() {
  return (
    <footer className="text-center lg:text-left bg-[#00042D] text-white">
      <div className="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
        ...
        <div className="flex justify-center">
          ...
          <a href="https://github.com/Waheedsadique" className="text-gray-600">
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fab"
      ...
      <div className="text-center p-6 bg-red-100 flex space-x-2 justify-center border border-b-2 border-red-700">
        ...
        <Image src={"/waheed.jpg"} height={30} width={30} alt="waheed" className="rounded-full"/>
      </div>
    </footer>
  )
}
